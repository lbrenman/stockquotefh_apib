...
module.exports = {
	...
	// Replaces the human readable logging of API Builder with a JSON equivalent
	// that can be parsed in external logging tools.
	enableLoggingAsJSON: process.env.LOG_AS_JSON || false,
	...
	session: {
		...
		encryptionKey: 'FqiJcNYncKVhm0wjyJCleL39o42E5OCFWPHzVUH+SYY=',
		signatureAlgorithm: 'sha512-drop256',
		signatureKey: 'O0VnwFn/nK7LyVVY6YjMwHTFLancs8l7cKZNYWaySg6MNA+sVPn0gV/ZMu3/oV2LcEc9Bdls0gHKJmDpz5JUdg==',
		// should be a large unguessable string
		secret: 'sQi4xSCWYqKD5UU3fc+LoHRvvYCYnKur',
	...
	cookieSecret: 'Q+MTBERwLK5YIXA8vviL0QdfD2IQYLle',
